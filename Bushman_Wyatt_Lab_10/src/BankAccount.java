...
//Abstract will never be istantiated 
//You may not want to instantiated a bankaccount, but want features FROM a bank account
// WHICH IS THE WHOLE POINT OF INHERITANCE
//Checking account has 1 field, but it actually has 5 because Bank account has 4, so 4+1
//
